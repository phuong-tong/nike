...
import * as action from "../NavMainComponents/module/action/actions";
...
const SignIn = (props) => {
  //console.log(props.open); //successfully get open = false
          ...
          {userMenu && (
            <div className={classes.UserMenuContainer}>
              ...
              <Link to="/user/favorite" style={{ textDecoration: "none" }}>
                <div className={classes.UserMenuItem}> Favorite </div>
              </Link>
              <div
