  ...
  const checkOuts = () => {
    if (!JSON.parse(localStorage.getItem("user"))) {
      ...
      if (products.length > 0) {
        ...
        alert("Please add product before checking out");
      }
    }
  };
    ...
    <div className={classes.Summary}>
      ...
      <div className={classes.PriceDetail}>
          ...
          <Tooltip
            ...
            title={
              <div className={classes.HelpTooltip}>
                The subtotal reflects the total proce of your order, including
        ...
        <Hidden smDown>
          ...
          {checkOut && (
            <button onClick={transactionLive}> Payment on delivery</button>
          )}
        </Hidden>
      </div>
    </div>
